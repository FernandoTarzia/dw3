...
insert into cursos values(default, 'BSI', 'Bacharelado em Sistemas de Informação', true),
...
insert into alunos values (default,'pront1', 'Josédas Neves','Rua A,Votuporanga', 6891.60,'2000-01-31',
    (SELECT cursoid from CURSOS where codigo ='BSI')),
    (default,'pront2', 'MariaSilveira', 'RuaB, SãoJosé doRio Preto',7372.41, '2002-03-12',
...
insert into clientes values(default, 'CLI01', 'João da Silva', 'Rua A1', true),
...
insert into pedidos values (default, 234, '2020-01-31', 6891.60, (SELECT clienteid from CLIENTES where codigo = 'CLI01'))
    ON CONFLICT DO NOTHING;